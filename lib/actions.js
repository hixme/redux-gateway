...
exports.createRequest = exports.requestComplete = exports.requestFailure = exports.requestSuccess = exports.requestInit = exports.setClient = undefined;

var _actionTypes = require('./actionTypes');

var _actionTypes2 = _interopRequireDefault(_actionTypes);

var _gatewayManager = require('modules/gateway-manager');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var setClient = exports.setClient = function setClient(client) {
  return {
    type: _actionTypes2.default.SET_CLIENT,
    client: client
  };
};
...
var createRequest = exports.createRequest = function createRequest(_ref) {
  ...
  return function (dispatch) {
    ...
    return (0, _gatewayManager.gatewayRequest)(route, { params: params, body: body }).then(function (data) {
