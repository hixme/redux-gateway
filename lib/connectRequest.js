...
exports.default = function (params) {
  ...
  return function (View) {
    ...
    var mapViewDispatchToProps = function mapViewDispatchToProps(dispatch, request) {
