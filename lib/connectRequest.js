...
exports.default = function (params) {
  ...
  return function (View) {
    ...
    var mapStateToProps = params.mapStateToProps,
        mapDispatchToProps = params.mapDispatchToProps;


    var mapViewStateToProps = function mapViewStateToProps(state, ownProps) {
      var routeName = ownProps.routeName;
    ...
    var GatewayEvent = (_temp = _class = function (_Component) {
      ...
      _createClass(GatewayEvent, [{
        ...
        value: function componentWillMount() {
          var requestOnMount = params.requestOnMount,
              requestOnMountParams = params.requestOnMountParams,
              requestOnMountBody = params.requestOnMountBody;
        ...
        key: 'initRequest',
        value: function initRequest(props) {
      ...
      isRetrying: _react.PropTypes.bool,
      isComplete: _react.PropTypes.bool,
      createRequest: _react.PropTypes.func,
      clearRequest: _react.PropTypes.func,
      dispatch: _react.PropTypes.func,
      routeName: _react.PropTypes.string
    }, _temp);


    var mapRequestStateToProps = function mapRequestStateToProps(state, ownProps) {
      var routeName = params.name && (0, _isFunction2.default)(params.name) ? params.name(state, ownProps) : params.name || params.route;
      return {
        routeName: routeName,
